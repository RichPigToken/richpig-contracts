...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOKEN_PER_BLOCK = 1000000000000000000;
    ...
    function updateEmissionRate(uint256 _tokenPerBlock) public onlyOwner {
        require(_tokenPerBlock <= MAX_TOKEN_PER_BLOCK, "updateEmissionRate: exceeded max emission rate");
        massUpdatePools();
        tokenPerBlock = _tokenPerBlock;
